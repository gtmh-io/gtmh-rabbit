...
namespace GTMH.S11n.UnitTests.Impl
{
  ...
  {
    [GTField(GTInit=true, AKA="OldInstances")]
    public ImmutableArray<Interface_t?> Instances { get; }
  ...
  {
    [GTField(GTInit=true, Parse=nameof(Parse), DeParse=nameof(DeParse))]
    public ImmutableArray<Interface_t?> Instances { get; }
  ...
  {
    [GTField(GTInit=true, Parse=nameof(Parse), DeParse=nameof(DeParse), AKA ="OldInstances")]
    public ImmutableArray<Interface_t?> Instances { get; }
